...
Build Instructions
Open RealityExGuard 1.0.0.slnx in Visual Studio 2026.

Set the platform to Release | x86.

Ensure the Character Set is set to Multi-Byte.

Build the solution to generate RealityExGuard.dll.
